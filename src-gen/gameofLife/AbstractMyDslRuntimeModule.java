...
import gameofLife.generator.MyDslGenerator;
import gameofLife.parser.antlr.MyDslAntlrTokenFileProvider;
import gameofLife.parser.antlr.MyDslParser;
import gameofLife.parser.antlr.internal.InternalMyDslLexer;
import gameofLife.scoping.MyDslScopeProvider;
import gameofLife.serializer.MyDslSemanticSequencer;
import gameofLife.serializer.MyDslSyntacticSequencer;
import gameofLife.services.MyDslGrammarAccess;
import gameofLife.validation.MyDslConfigurableIssueCodesProvider;
import gameofLife.validation.MyDslValidator;
...
public abstract class AbstractMyDslRuntimeModule extends DefaultRuntimeModule {
	...
	public void configure(Binder binder) {
		properties = tryBindProperties(binder, "gameofLife/MyDsl.properties");
		super.configure(binder);
	}
	
	public void configureLanguageName(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(Constants.LANGUAGE_NAME)).toInstance("gameofLife.MyDsl");
	}
